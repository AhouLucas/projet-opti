...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{Q1/capacity_distribution.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{Q1/execution_time.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{Q1/energy_produced.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{Q1/efficiency.pdf}
...
\footnote{L'énergie maximale productible est $P\times m = 4.38\times 10^9 [\mathrm{MWh}]$. En prenant $E_{\text{max}} = 10^9 [\mathrm{MWh}]$, on reste dans une plage de valeurs raisonnable car cela représente une fraction de la quantité totale d'énergie productible.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{Q2/minimal_energy_produced.pdf}
    \caption{Graphe du minimum de production en fonction de l'énergie maximale achetable}
    \label{fig:minimal_energy_produced_Q2}
\end{figure}
\noindent
Comme nous pouvons le voir, au plus nous achetons de l'énergie, au mieux c'est. Nous choisissons donc une valeur de $E_{\text{max}} = 10^9 [\mathrm{MWh}]$.\\
Nous avons représenté ci-dessous la production totale d'énergie en fonction du temps ainsi que les productions éoliennes et l'énergie achetée individuellement :

\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{Q2/energy_produced_and_bought.pdf}
    \caption{Graphe de la production totale d'énergie pour $E_{\text{max}} = 10^9 [\mathrm{MWh}]$}
    \label{fig:total_energy_produced_and_bought_Q2}
\end{figure}

\noindent
Comme nous pouvons le voir sur les graphes, le solver achète de l'énergie afin que la production soit constante au cours de l'année.\\
Cette décision était prévisible puisque l'objectif est de maximiser le minimum de production. La solution optimale est donc lorsque le minimum atteint le maximum du graphe ce qui implique que la fonction est constante.
