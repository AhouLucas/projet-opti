...
\begin{table}[h!]
    ...
    \begin{tabular}{|c || c |} 
        ...
        \hline
    \end{tabular}
    \caption{Table des notations des variables de décisions utilisées pour le modèle}
    \label{table:notations_variables}
\end{table}
...
\begin{align}
    \min_{c,t,p} \quad &\mathrm{costs}^\intercal\mathbf{c} \nonumber\\
