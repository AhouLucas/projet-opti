...
Les puissances de turbinage/pompage sont cependant assez différents que le modèle précédent. Nous rencontrons beaucoup plus de valeurs extrêmes comme nous pouvons le voir sur la figure \ref{fig:Turbinage_pompage_Q5}.
...
Le temps de résolution est quant à lui bien plus faible que celui du premier modèle.
En effet, celui-ci a pris $19 \mathrm{min} 44.6 \mathrm{s}$ à s'exécuter contre $42\mathrm{min} 44.7\mathrm{s}$ pour le modèle de la question 4.
